    ...
    <ul className="navbar-nav">
      <li className="logo">
        <a href="#" className="nav-link">
          <span className="link-text logo-text">DASH</span>
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
      ...
      <li className="nav-item">
        <a href="#" className="nav-link">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 576 512"
            className="svg-inline--fa fas fa-user-alt fa-w-18 fa-9x"
          >
          </svg>
        ...
        <a href="#" className="nav-link">
          ...
          >
            <g className="fa-group">
              ...
              <path
                fill="currentColor"
                d="M592.6 208.24C559.73 192.84 515.78 184 472 184H186.54a45.62 45.62 0 0 0-40.2-H24H32c-23.2 0-32 10-32 24v144c0 14 8.82 24 32 24h114.34a45.62 45.62 0 0 0 40.2-24H472c43.78 0 87.73-8.84 120.6-24.24C622.28 289.84 640 272 640 256s-17.72-33.84-47.4-47.76zM488 296a8 8 0 0 1-8-8v-64a8 8 0 0 1 8-8c31.91 0 31.94 80 0 80z"
                className="fa-primary"
              ></path>
            </g>
          </svg>
